    ...
    <Card :bordered="false" v-bind:style="{ width: windowWidth*0.98 + 'px' }">
      <div slot="title">
        <Row type="flex" justify="center" align="middle">
          ...
          <Col span="2">
            <Button v-if="hasUserAccess" type="primary" @click="addUser">添加用户</Button>
          </Col>
        </Row>
      </div>
      <super_table @onClick="onTableClick" :pageSize="countPerPage" :current.sync="currentPage"
                   @onDoubleClick="onTableDoubleClick" @onSearch="onTableSearch" :data="userData"
                   :columns="tableColumns" :isLoading="isTableLoading" :dataNum="userDataCount"></super_table>
    </Card>
    <Card :bordered="false" v-bind:style="{ width: windowWidth*0.98 + 'px' ,marginTop:'10px'}">
      <div slot="title">
        <Row type="flex" justify="center" align="middle">
          ...
          <Col span="2">
            <Button v-if="hasUserAccess" type="primary" @click="addRole">添加角色</Button>
          </Col>
        </Row>
      </div>
